...
# 抓取的最多微博数
MAX_WEIBO = user_config.job.max_weibo

# 抓取的最多转发、评论和like数量
MAX_FORWARDS = user_config.job.fetch.max_forwards
MAX_COMMENTS = user_config.job.fetch.max_comments
MAX_LIKES = user_config.job.fetch.max_likes

# 是否抓取关注的人以及粉丝
fetch_follows = user_config.job.fetch.follows
fetch_fans = user_config.job.fetch.fans
MAX_FOLLOWS = user_config.job.fetch.max_follows
MAX_FANS = user_config.job.fetch.max_fans
